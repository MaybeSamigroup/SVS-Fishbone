...
namespace Fishbone
{
    ...
    public static partial class Extension
    {
        ...
        public static IDisposable[] Register<T, U>()
            ...
            Hooks.OnActorsCleanup.Subscribe(Extension<T, U>.ClearActors),
        ...
        public static IDisposable[] Register<T>()
            ...
            Hooks.OnActorsCleanup.Subscribe(Extension<T>.ClearActors),
    ...
    /// <summary>
    /// AC platform plugin marker for Fishbone.
    /// </summary>
